...
<head>
    ...
    <link rel="stylesheet" href="{% static "rosetta-admin/css/base.css" %}" type="text/css"/>
    <link rel="stylesheet" href="{% static "rosetta-admin/css/forms.css" %}" type="text/css"/>
    <link rel="stylesheet" href="{% static "rosetta-admin/css/changelists.css" %}" type="text/css"/>
